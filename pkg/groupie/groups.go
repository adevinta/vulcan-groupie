...
var (
	...
	vuln2Group = map[string]string{
		...
		"PHP 7.3.x < 7.3.21 Use-After-Free Vulnerability":                                     "php",
		"PHP 7.2.x / 7.3.x < 7.3.22 Memory Leak Vulnerability":                                "php",
		"PHP 7.2 < 7.2.34 / 7.3.x < 7.3.23 / 7.4.x < 7.4.11 Mulitiple Vulnerabilities":        "php",
		"PHP < 7.3.24 Multiple Vulnerabilities":                                               "php",
		...
		"WordPress <= 5.3 - Authenticated Improper Access Controls in REST API":                        "wordpress",
		"WordPress <= 5.3 - Authenticated Stored XSS via Crafted Links":                                "wordpress",
		"WordPress <= 5.3 - Authenticated Stored XSS via Block Editor Content":                         "wordpress",
		"WordPress < 5.4.1 - Unauthenticated Users View Private Posts":                                 "wordpress",
		"WordPress < 5.4.1 - Authenticated Cross-Site Scripting (XSS) in Customizer":                   "wordpress",
		"WordPress < 5.4.1 - Cross-Site Scripting (XSS) in wp-object-cache":                            "wordpress",
		"WordPress < 5.4.1 - Authenticated Cross-Site Scripting (XSS) in File Uploads":                 "wordpress",
		"WordPress <= 5.2.3 - Hardening Bypass":                                                        "wordpress",
		"WordPress < 5.4.2 - Authenticated XSS via Media Files":                                        "wordpress",
		"WordPress < 5.4.2 - Open Redirection":                                                         "wordpress",
		"WordPress < 5.4.2 - Authenticated Stored XSS via Theme Upload":                                "wordpress",
		"WordPress < 5.4.2 - Misuse of set-screen-option Leading to Privilege Escalation":              "wordpress",
		"WordPress < 5.5.2 - Cross-Site Scripting (XSS) via Global Variables":                          "wordpress",
		"WordPress < 5.5.2 - XML-RPC Privilege Escalation":                                             "wordpress",
		"WordPress < 5.5.2 - Unauthenticated DoS Attack to RCE":                                        "wordpress",
		"WordPress < 5.5.2 - Stored XSS in Post Slugs":                                                 "wordpress",
		"WordPress < 5.5.2 - Cross-Site Request Forgery (CSRF) to Change Theme Background":             "wordpress",
		...
		"Multiple vulnerabilities in ProFTPD":                                                                    "other-vulnerabilities",
		"Multiple vulnerabilities in Exim smtpd":                                                                 "other-vulnerabilities",
		"Exim < 4.89.1 Use-After-Free BDAT Remote Code Execution":                                                "other-vulnerabilities",
